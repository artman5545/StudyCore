...
{
    public class AppRepository<T, TKey> : EfCoreRepositoryBase<CoreDB, T, TKey> where T : class, IEntity<TKey>
    {
        ...
        public AppRepository(IDbContextProvider<CoreDB> dbContextProvider)
    ...
    public class AppRepository<T> : AppRepository<T, Guid> where T : class, IEntity<Guid>
    {
        /// <summary>
        /// 数据库类型
        /// </summary>
